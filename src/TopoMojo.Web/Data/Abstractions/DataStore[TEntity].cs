...
namespace TopoMojo.Data
{
        ...
        where TEntity : class, IEntity
    {
        ...
        {
            return await Retrieve(id, null);
        }

        public virtual async Task<TEntity> Retrieve(int id, Func<IQueryable<TEntity>, IQueryable<TEntity>> includes)
        {
            if (id == 0)
                return null;
        ...
        public virtual async Task<TEntity> Retrieve(string id)
        {
            return await Retrieve(id, null);
        }
        ...
        public virtual async Task<TEntity> Retrieve(string id, Func<IQueryable<TEntity>, IQueryable<TEntity>> includes)
        {
            ...
            if (IdMap.TryGetValue(id, out int i))
                return await Retrieve(i, includes);
            ...
            return await Retrieve(actualId, includes);
        }
